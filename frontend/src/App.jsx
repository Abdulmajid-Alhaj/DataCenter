...
import DataAnalyser from "./pages/Analyser/DataAnalyser";
import HealthAnalyser from "./pages/Analyser/HealthAnalyser";
import Population from "./pages/Analyser/Population";
import Education from "./pages/Analyser/Education";
import Financial from "./pages/Analyser/Financial";
